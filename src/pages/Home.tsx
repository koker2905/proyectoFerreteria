...
export function Home() {
  ...
  // FUNCIÓN CORREGIDA: Sin duplicados y con lógica limpia
  const handlePredict = async () => {
    ...
    try {
      // Opción 1: Si usas tu función apiPredict ya configurada
      ...
      if (response) {
        ...
        alert("No se obtuvo respuesta de la predicción.");
      }
    } catch (error) {
      console.error("Error al predecir:", error);
      alert("Hubo un error al conectar con el servidor de ML.");
    }
  };
